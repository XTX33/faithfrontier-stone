...
- Essays, articles, commentary, theological writings, and investigative notes
- Case summaries, docket metadata, annotations, and narrative structures
- Visual branding, logos, seals, typography, art, and conceptual frameworks
- Analytical structures, journalistic constructs, and interpretive models
- Document organization systems, metadata schemas, intake scripts, and case architecture outputs

These materials are **not** open-source and may not be reused without written permission.
...
- Use government-issued public-record filings supplied here (not the FaithFrontier summaries)
...
- Commercialize any FaithFrontier narrative, imagery, or metadata structures
- Use case materials in ways that harass, intimidate, or harm any parties
- Impersonate or misrepresent FaithFrontier, its maintainers, or its mission
